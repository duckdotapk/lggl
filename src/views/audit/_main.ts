...
{
	const totalProblems = options.problemLists.reduce(
		(total, problemList) => total + problemList.problems.length,
		0,
	);
		...
		[
			...
			[
				...
				[
					...
					" ",
					Anchor(
						new DE("span", "fa-solid fa-pen-to-square"),
						problemList.editHref,
						"_blank",
					),
				]),
