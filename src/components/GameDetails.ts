...
import
{
	...
	getGameSteamDeckCompatibilityIconName,
				...
				? DataList(gameDevelopers.map((gameDeveloper) =>
					({
						name: Anchor(
							...
							"/companies/view/" + gameDeveloper.company.id,
						),
			...
			gamePublishers.length > 0
				...
				({
					name: Anchor(
						...
						"/companies/view/" + gamePublisher.company.id,
					),
			...
			game.gamePlatforms.length > 0
				...
				({
					...
					name: Anchor(
						...
						"/platforms/view/" + gamePlatform.platform.id,
					),
			...
			[
				{
					...
					value: game.progressionType != null
						? getGameProgressionTypeName(game)
						: MissingData(),
				},
				{
					name: "Achievement support",
					value: game.achievementSupport != null
						? getGameAchievementSupportName(game)
						: MissingData(),
				},
				{
					name: "Controller support",
					value: game.controllerSupport != null
						? getGameControllerSupportName(game)
						: MissingData(),
				},
				{
					name: "Mod support",
					value: game.modSupport != null
						? getGameModSupportName(game)
						: MissingData(),
				},
				{
					name: "VR support",
					value: game.virtualRealitySupport != null
						? getGameVirtualRealitySupportName(game)
						: MissingData(),
				},
			]),
		]),
		...
		game.steamAppId != null
			...
			[
				...
				[
					...
					{
						iconName: getGameSteamDeckCompatibilityIconName(game),
						name: "Steam Deck compatibility",
						value: game.steamDeckCompatibility != null
							? getGameSteamDeckCompatibilityName(game)
							: MissingData(),
					},
				]),
			])
